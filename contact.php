...
-->
  ...
  <body>
          ...
          <div class="col-12">
            <nav class="main-nav">
              ...
              <ul class="nav">
                ...
                <li class="scroll-to-section"><a href="voucher.php" class="active">Contat Us</a></li>
                <li class="submenu">
    ...
    <section id="voucher-banner">
      <img src="assets/images/bnrcontact.jpg" />
    </section>
    ...
    <!-- ***** Contact Area End ***** -->
        <section id="contact">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-lg-offset-2 m">
                  <div class="tittle">
                  <h1>Get in touch with <span>us</span><a href=""></a></h1>
                  <p>Say Hello. Don't Be Shy!</p>
                  </div>
                    <form id="contact-form" method="post" role="form" class="form">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                ...
                                <div class="button">
                                <div class="col-md-12">
                                <input type="submit" name="ok" class="btn btn-send" value="Send message">
                                </div>
                                </div>
                            </div>
                        </div>
