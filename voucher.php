...
-->
  ...
  <body>
          ...
          <div class="col-12">
            <nav class="main-nav">
              ...
              <ul class="nav">
                ...
                <li class="scroll-to-section"><a href="voucher.php" class="active">Voucher</a></li>
                <li class="submenu">
    ...
    <!-- ***** Header Area End ***** -->
    <!-- ***** Banner Voucher Area Start ***** -->
    <section id="voucher-banner">
      <img src="assets/images/bnrvouc.jpg" />
    </section>
    <!-- ***** Banner Voucher Area End ***** -->

    <!-- ***** Products Area Starts ***** -->
    <div class="container">
      <div id="voucher">
        <div class="voc" data-name="15k">
          <img src="assets/images/voucher 15k.jpg" />
          <a class="voc-btn" href="login.php">get now!</a>
        </div>
        <div class="voc" data-name="25k">
          <img src="assets/images/voucher 25k.jpg" />
          <a class="voc-btn" href="login.php">get now!</a>
        </div>
        <div class="voc" data-name="50k">
          <img src="assets/images/voucher 50k.jpg" />
          <a class="voc-btn" href="login.php">get now!</a>
        </div>
      </div>
    </div>
